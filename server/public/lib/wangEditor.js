    ...
    show: function show() {
        ...
        tabs.forEach(function (tab, index) {
            ...
            events.forEach(function (event) {
                ...
                $content.find(selector).on(type,list, function (e) {
                    e.stopPropagation();
                    var needToHide = fn(e);
                    // 执行完事件之后，是否要关闭 panel
                    if (needToHide) {
...
UploadImg.prototype = {
    ...
    insertLinkImg: function insertLinkImg(link) {
        ...
        editor.cmd.do('insertHTML', '<img src="' + link + '" style="max-width:auto;"/>');
    ...
    insertLinkImgMore: function insertLinkImgMore(link) {
        ...
        a.map(function(ver){
            html += '<img src="'+ver+'" style="max-width:auto;"/>'
        })
...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        if (textSelector == null) {
            ...
            // 自行创建的，需要配置默认的样式
            $toolbarElem.css('background-color', '#f1f1f1').css('border', '1px solid #ccc').css('border-radius','4px 4px 0 0 ');
            $textContainerElem.css('border', '1px solid #ccc').css('border-top', 'none').css('height', '520px').css('border-radius','0 0 4px 4px');
        } else {
